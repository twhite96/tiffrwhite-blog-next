...
// const PostStar = (
//   <>
//     <span className='star-container' title='star'>
//       *
//     </span>
//     <style jsx>{`
//       .star-container {
...
export default function PostList({ item, showYears = false }) {
  ...
  return <div>{posts.map((post) => Post(post, false))}</div>;
}

function Post({ id, description, date, title }, withStar: boolean) {
  return (
    <div key={id}>
      <div className='post'>
