...
const getNextPlausibleProxyEnv = (options) => ({
...
function withPlausibleProxy(options = {}) {
    return (nextConfig) => {
        ...
        return Object.assign(Object.assign({}, nextConfig), { env: Object.assign(Object.assign({}, nextConfig.env), getNextPlausibleProxyEnv(nextPlausiblePublicProxyOptions)), rewrites: () => __awaiter(this, void 0, void 0, function* () {
                var _a;
